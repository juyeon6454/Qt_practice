...
void ImageView::pinchTriggered(QPinchGesture *gesture)
{
    ...
    QPinchGesture::ChangeFlags changesFlags = gesture->changeFlags();
    if(changesFlags & QPinchGesture::RotationAngleChanged){
        qreal rotationDelta = gesture->rotationAngle()-gesture->lastRotationAngle();
        _rotationAngle += rotationDelta;
    }
    if(changesFlags & QPinchGesture::ScaleFactorChanged)
